...
intents = {
    ...
    "greetings":{
        "patterns": ['hello','hii','namaste','hey'],
        "responses": ['Hello sir, how are you?','Hello sir , how can i assist you!!','Welcome back sir!']
    },
    "DateofBirth":{
        "patterns": ['What is your age?','Who makes you?'],
        "responses": ['I am a vertual assistent made by superAman, My date of birth is 22/12/2023','Hello sir ,22/12/2023 is my date of birth']
    },
    "goodbye":{
        "patterns": ['bye','stop','go to hell','bhaag ja','nikal'],
        "responses": ['Nice to meet you, Sir','Take Care and Have a nice day Sir!','Time to take a good rest, Adios Sir']
    },
    "gratitude": {
    ...
    "book_recommendation": {
        ...
        "responses": ["How about reading Atomic Habbit?", "I've got some great book recommendations for you!", "Let me suggest some interesting books for you to read."]
    },
    "fitness_tips": {
